  ...
  [179],
  {
              ...
              o !== document.title && (document.title = o),
                ["meta", "base", "link", "style", "script"].forEach(function (e) {
                  !(function (e, t) {
                    ...
                    0;
                    for (
                      var i = Number(o.content), u = [], c = 0, s = o.previousElementSibling;
                      c < i;
              ...
              value: function () {
                this.scrollToHash(),
                  h.isSsr &&
                    ...
                    "/_error" !== N.page &&
                    (N.isFallback ||
                      (N.nextExport && (b.isDynamicRoute(h.pathname) || location.search, 1)) ||
                      (N.props && N.props.__N_SSG && (location.search, 1))) &&
                    h
                      .replace(h.pathname + "?" + String(_.assign(_.urlQueryToSearchParams(h.query), new URLSearchParams(location.search))), I, {
                        _h: 1,
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        (t = N.assetPrefix || ""),
                        (r.p = "".concat(t, "/_next/")),
                        x.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: N.runtimeConfig || {} }),
                        (I = w.getURL()),
                        A.hasBasePath(I) && (I = C.removeBasePath(I)),
                        N.scriptLoader && ((o = r(72189)), (0, o.initScriptLoader)(N.scriptLoader)),
          ...
          D.loadPage("/_error")
            ...
            .then(function (r) {
              var a,
                ...
                i = r.styleSheets,
                u = Y(t),
                c = { Component: o, AppTree: u, router: h, ctx: { err: n, pathname: N.page, query: N.query, asPath: I, AppTree: u } };
              return Promise.resolve((null == (a = e.props) ? void 0 : a.err) ? e.props : w.loadGetInitialProps(t, c)).then(function (t) {
                return ie(d({}, e, { err: n, Component: o, styleSheets: i, props: t }));
              });
            })
        );
      }
      ...
      function ae() {
        if (w.ST) {
          ...
          e.length &&
            ...
            W &&
              (performance.getEntriesByName("Next.js-render").forEach(W), performance.getEntriesByName("Next.js-route-change-to-render").forEach(W)),
            re(),
      ...
      function ie(e) {
        ...
        var f = v.default.createElement(
          ...
          v.default.createElement(
            ...
            null,
            X(t, i),
            v.default.createElement(P.Portal, { type: "next-route-announcer" }, v.default.createElement(j.RouteAnnouncer, null))
          )
        );
        return (
          (function (e, t) {
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 37:
                      if (
                        (($ = e.sent), (s = { App: F, initial: !0, Component: z, props: N.props, err: a }), !(null == r ? void 0 : r.beforeRender))
                      ) {
                        e.next = 42;
                        break;
                      }
      ...
      var a = (0, r(92648).Z)(r(67294)),
        ...
        u = function () {
          ...
          return (
            ...
            a.default.createElement("p", { "aria-live": "assertive", id: "__next-route-announcer__", role: "alert", style: i }, u)
          );
        };
      t.RouteAnnouncer = u;
      var c = u;
        ...
        v = function (e) {
          ...
          if (!g || !p.has(g)) {
            ...
            c
              ...
              : f
              ? ((_.textContent = "string" === typeof f ? f : Array.isArray(f) ? f.join("") : ""), b())
              : t && ((_.src = t), d.set(t, x));
      ...
      function y(e) {
        ...
        return (
          ...
          ("beforeInteractive" !== m && "worker" !== m) ||
            (_
              ? ((x[m] = (x[m] || []).concat([o({ id: t, src: n, onLoad: i, onReady: d, onError: y }, g)])), _(x))
              : w && w()
              ? p.add(t || n)
              : w && !w() && v(e)),
          null
    ...
    64957: function (e, t, r) {
            ...
            return i.wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 5:
                    return (
                      (n = j.parsePath(t.asPath)),
                      (a = n.pathname),
                      (o = A.hasBasePath(a) ? M.removeBasePath(a) : a),
                      (u = C.addBasePath(R.addLocale(o, t.locale))),
                      e.abrupt(
                        "return",
                        r.some(function (e) {
      ...
      function z(e, t, r) {
        ...
        if ((i.split("?")[0] || "").match(/(\/\/|\\)/)) {
          console.error(
            "Invalid href passed to next/router: ".concat(a, ", repeated forward-slashes (//) or backslashes \\ are not valid in the href")
          );
            ...
            ? e
                ...
                .then(function (t) {
                  return (function (e, t, r) {
                    var n = { basePath: r.router.basePath, i18n: { locales: r.router.locales }, trailingSlash: Boolean(!1) },
                    ...
                    if ((!u || i || u.includes("__next_data_catchall") || u.includes("/_error") || u.includes("/404") || (i = u), i)) {
                      if (i.startsWith("/")) {
                        var s = x.parseRelativeUrl(i),
                          l = L.getNextPathnameInfo(s.pathname, { nextConfig: n, parseData: !0 }),
                        ...
                        return Promise.all([r.router.pageLoader.getPageList(), p.getClientBuildManifest()]).then(function (t) {
                          ...
                          if (_.isDynamicRoute(c) || (!a && i.includes(y.normalizeLocalePath(M.removeBasePath(c), r.router.locales).pathname))) {
                            var d = L.getNextPathnameInfo(x.parseRelativeUrl(e).pathname, { parseData: !0 });
                      ...
                      var h = j.parsePath(e),
                        v = T.formatNextPathnameInfo(
                          c({}, L.getNextPathnameInfo(h.pathname, { nextConfig: n, parseData: !0 }), {
                            defaultLocale: r.router.defaultLocale,
                            buildId: "",
                          })
                        );
                      return Promise.resolve({ type: "redirect-external", destination: "".concat(v).concat(h.query).concat(h.hash) });
                    }
                      ...
                      if (m.startsWith("/")) {
                        var g = j.parsePath(m),
                          b = T.formatNextPathnameInfo(
                            c({}, L.getNextPathnameInfo(g.pathname, { nextConfig: n, parseData: !0 }), {
                              defaultLocale: r.router.defaultLocale,
                              buildId: "",
                            })
                          );
                    ...
                    return { dataHref: t.dataHref, cacheKey: t.cacheKey, json: t.json, response: t.response, text: t.text, effect: e };
                  });
                })
                .catch(function (e) {
                  return null;
      ...
      function J(e) {
        var t,
          ...
          d = function (e) {
            return K(r, i ? 3 : 1, { headers: a ? { purpose: "prefetch" } : {}, method: null != (t = null == e ? void 0 : e.method) ? t : "GET" })
              .then(function (t) {
                      ...
                      if (!t.ok) {
                        ...
                        if (!o && 404 === t.status)
                          if (null == (n = Y(e)) ? void 0 : n.notFound)
                            return { dataHref: r, json: { notFound: V }, response: t, text: e, cacheKey: f };
                        var a = new Error("Failed to load static props");
                        throw (i || p.markAssetError(a), a);
                      }
                      return { dataHref: r, json: u ? Y(e) : null, response: t, text: e, cacheKey: f };
                    });
              })
              .then(function (e) {
        ...
        ne = (function () {
          function e(t, r, a, o) {
              ...
              (this.onPopState = function (e) {
                ...
                if (r) {
                  if (r.__NA) window.location.reload();
                    ...
                    (i.isSsr && a === C.addBasePath(i.asPath) && c === C.addBasePath(i.pathname)) ||
                      (i._bps && !i._bps(r)) ||
                      i.change(
                        "replaceState",
                        n,
                        a,
                        Object.assign({}, o, { shallow: o.shallow && i._shallow, locale: o.locale || i.defaultLocale, _h: 0 }),
                        undefined
                      );
                  }
                } else {
                  var s = i.pathname,
                    l = i.query;
                  i.changeState("replaceState", O.formatWithValidation({ pathname: C.addBasePath(s), query: l }), b.getURL());
                }
              });
            var g = d.removeTrailingSlash(t);
            (this.components = {}),
              "/_error" !== t &&
                (this.components[g] = { Component: f, initial: !0, props: u, err: p, __N_SSG: u && u.__N_SSG, __N_SSP: u && u.__N_SSP }),
            ...
            if (
              ...
              (this.state = { route: g, pathname: t, query: r, asPath: w ? t : a, isPreview: !!y, locale: void 0, isFallback: v }),
              (this._initialMatchesMiddlewarePromise = Promise.resolve(!1)),
              !a.startsWith("//"))
            ) {
              var P = { locale: m },
                E = b.getURL();
              this._initialMatchesMiddlewarePromise = B({ router: this, locale: m, asPath: E }).then(function (e) {
                return (
                  (P._shouldResolveHref = a !== t),
                  i.changeState("replaceState", e ? E : O.formatWithValidation({ pathname: C.addBasePath(t), query: r }), E, P),
                  e
                );
              });
            }
          ...
          return (
            a(e, [
                          ...
                          for (;;)
                            switch ((i.prev = i.next)) {
                              case 0:
                                ...
                                return te({ url: r, router: l }), i.abrupt("return", !1);
                              case 3:
                                if (
                                  ((f = a._h),
                                  (m = f || a._shouldResolveHref || j.parsePath(r).pathname === j.parsePath(n).pathname),
                                  (y = c({}, l.state)),
                                  (g = !0 !== l.isReady),
                                  (l.isReady = !0),
                                  (w = l.isSsr),
                              ...
                              case 25:
                                if (
                                  ...
                                  l._inFlightRoute &&
                                    l.clc &&
                                    (w || e.events.emit("routeChangeError", D(), l._inFlightRoute, $), l.clc(), (l.clc = null)),
                                  (n = C.addBasePath(R.addLocale(A.hasBasePath(n) ? M.removeBasePath(n) : n, a.locale, l.defaultLocale))),
                                  (K = k.removeLocale(A.hasBasePath(n) ? M.removeBasePath(n) : n, y.locale)),
                                  (l._inFlightRoute = n),
                                  (X = L !== y.locale),
                                ...
                                return (
                                  (y.asPath = K),
                                  e.events.emit("hashChangeStart", n, $),
                              ...
                              case 43:
                                throw (
                                  ((i.prev = 43),
                                  (i.t0 = i.catch(38)),
                                  v.default(i.t0) && i.t0.cancelled && e.events.emit("routeChangeError", i.t0, K, $),
                                  i.t0)
                                );
                              case 47:
                              ...
                              case 49:
                                return (
                                  ...
                                  (i.prev = 51),
                                  (i.next = 54),
                                  Promise.all([l.pageLoader.getPageList(), p.getClientBuildManifest(), l.pageLoader.getMiddleware()])
                                );
                              case 54:
                                (ne = i.sent), (ae = o(ne, 2)), (ee = ae[0]), (re = ae[1].__rewrites), (i.next = 64);
                                break;
                              case 60:
                                return (i.prev = 60), (i.t1 = i.catch(51)), te({ url: n, router: l }), i.abrupt("return", !1);
                              case 64:
                                return (
                                  l.urlIsNew(K) || X || (t = "replaceState"),
                                  (oe = n),
                                  (Y = Y ? d.removeTrailingSlash(M.removeBasePath(Y)) : Y),
                                  (i.next = 69),
                              ...
                              case 69:
                                ...
                                if (
                                  !(ue = P.default(
                                    C.addBasePath(R.addLocale(K, y.locale), !0),
                                    ee,
                                    re,
                                    J,
                                    function (e) {
                                ...
                                return te({ url: n, router: l }), i.abrupt("return", !0);
                              case 78:
                                ie || (oe = ue.asPath),
                                  ue.matchedPage &&
                                    ue.resolvedHref &&
                                    ((Y = ue.resolvedHref), (Q.pathname = C.addBasePath(Y)), ie || (r = O.formatWithValidation(Q))),
                                  (i.next = 84);
                                break;
                              case 82:
                                (Q.pathname = Z(Y, ee)),
                                  Q.pathname !== Y && ((Y = Q.pathname), (Q.pathname = C.addBasePath(Y)), ie || (r = O.formatWithValidation(Q)));
                              case 84:
                                if (F(n)) {
                                  i.next = 89;
                                  break;
                                ...
                                break;
                              case 87:
                                return te({ url: n, router: l }), i.abrupt("return", !1);
                              case 89:
                                if (
                                  ((oe = k.removeLocale(M.removeBasePath(oe), y.locale)),
                                  (ce = d.removeTrailingSlash(Y)),
                                  (se = !1),
                                  !_.isDynamicRoute(ce))
                                ) {
                                  i.next = 107;
                                ...
                                if (
                                  !(
                                    (he = Object.keys(fe.groups).filter(function (e) {
                                      return !J[e];
                                    })).length > 0
                                  ) ||
                                  ie
                                ...
                                throw new Error(
                                  (de
                                    ? "The provided `href` ("
                                        ...
                                        .concat(he.join(", "), ") to be interpolated properly. ")
                                    : "The provided `as` value (".concat(le, ") is incompatible with the `href` value (").concat(ce, "). ")) +
                                    "Read more: https://nextjs.org/docs/messages/".concat(de ? "href-interpolation-failed" : "incompatible-href-as")
                                );
                              case 104:
                                i.next = 107;
                                break;
                              case 106:
                                de
                                  ? (n = O.formatWithValidation(Object.assign({}, T, { pathname: pe.result, query: H(J, pe.params) })))
                                  : Object.assign(J, se);
                              case 107:
                                return (
                                  f || e.events.emit("routeChangeStart", n, $),
                                  (i.prev = 108),
                                  (i.next = 111),
                                  l.getRouteInfo({
                                    route: ce,
                              ...
                              case 111:
                                if (
                                  ("route" in (ye = i.sent) &&
                                    ...
                                    ((Y = ye.route || ce),
                                    (ce = Y),
                                    $.shallow || (J = Object.assign({}, ye.query || {}, J)),
                                    (ge = A.hasBasePath(Q.pathname) ? M.removeBasePath(Q.pathname) : Q.pathname),
                                    se &&
                                      Y !== ge &&
                                    ...
                                    _.isDynamicRoute(Y) &&
                                      ((be =
                                        !$.shallow && ye.resolvedAs
                                          ? ye.resolvedAs
                                          : C.addBasePath(R.addLocale(new URL(n, location.href).pathname, y.locale), !0)),
                                      (_e = be),
                                      A.hasBasePath(_e) && (_e = M.removeBasePath(_e)),
                                      (xe = S.getRouteRegex(Y)),
                                      (we = E.getRouteMatcher(xe)(_e)) && Object.assign(J, we))),
                                  !("type" in ye))
                                ) {
                                  i.next = 120;
                                  break;
                              ...
                              case 118:
                                return te({ url: ye.destination, router: l }), i.abrupt("return", new Promise(function () {}));
                              case 120:
                                if (
                                  ((Ee = (Pe = ye).error),
                                  (Se = Pe.props),
                                  ...
                                  (je = Pe.__N_SSP),
                                  (Re = ye.Component) &&
                                    Re.unstable_scriptLoader &&
                                    [].concat(Re.unstable_scriptLoader()).forEach(function (e) {
                                ...
                                if (
                                  ((a.locale = !1), !(ke = Se.pageProps.__N_REDIRECT).startsWith("/") || !1 === Se.pageProps.__N_REDIRECT_BASE_PATH)
                                ) {
                                  i.next = 132;
                                  break;
                                }
                                return (
                                  ((Me = x.parseRelativeUrl(ke)).pathname = Z(Me.pathname, ee)),
                                  (Ce = G(l, ke, ke)),
                                  (Ae = Ce.url),
                                  (Le = Ce.as),
                                  i.abrupt("return", l.change(t, Ae, Le, a))
                                );
                              case 132:
                                return te({ url: ke, router: l }), i.abrupt("return", new Promise(function () {}));
                              case 134:
                              ...
                              case 150:
                                if (
                                  (e.events.emit("beforeHistoryChange", n, $),
                                  l.changeState(t, r, n, a),
                                  f &&
                                    "/_error" === Y &&
                                    500 === (null == (ve = self.__NEXT_DATA__.props) || null == (me = ve.pageProps) ? void 0 : me.statusCode) &&
                                    (null == Se ? void 0 : Se.pageProps) &&
                                    (Se.pageProps.statusCode = 500),
                                  (Ie = a.shallow && y.route === (null != (Ne = ye.route) ? Ne : ce)),
                                  (Be = null != (De = a.scroll) ? De : !a._h && !Ie),
                                  (qe = Be ? { x: 0, y: 0 } : null),
                                  (Ue = c({}, y, { route: ce, pathname: Y, query: J, asPath: K, isFallback: !1 })),
                                  (He = null != s ? s : qe),
                                  a._h && !He && !g && !X && N.compareRouterStates(Ue, l.state))
                                ) {
                                  i.next = 169;
                                  break;
                                }
                                return (
                                  (i.next = 162),
                                  l.set(Ue, ye, He).catch(function (e) {
                                    if (!e.cancelled) throw e;
                                    Ee = Ee || e;
                                  })
                                );
              ...
              },
              {
                ...
                value: function (e, t, r) {
                  ...
                  ("pushState" === e && b.getURL() === r) ||
                    ...
                    window.history[e]({ url: t, as: r, options: n, __N: !0, key: (this._key = "pushState" !== e ? this._key : ee()) }, "", r));
                },
              },
              {
                          ...
                          for (;;)
                            switch ((i.prev = i.next)) {
                              ...
                              case 3:
                                ...
                                throw (e.events.emit("routeChangeError", t, a, o), te({ url: a, router: s }), D());
                              case 7:
                              ...
                              case 10:
                                if (
                                  ...
                                  (f = l.page),
                                  (d = l.styleSheets),
                                  (h = { props: undefined, Component: f, styleSheets: d, err: t, error: t }).props)
                                ) {
                                  i.next = 25;
                                  break;
                                }
                                return (i.prev = 15), (i.next = 18), s.getInitialProps(f, { err: t, pathname: r, query: n });
                              case 18:
                              ...
                              case 28:
                                return (
                                  (i.prev = 28),
                                  (i.t1 = i.catch(7)),
                                  i.abrupt("return", s.handleRouteInfoError(v.default(i.t1) ? i.t1 : new Error(i.t1 + ""), r, n, a, o, !0))
                                );
                              case 31:
                              case "end":
                                return i.stop();
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                if (
                                  ((g = t), (e.prev = 1), (w = re({ route: g, router: m })), (P = m.components[g]), !s.shallow || !P || m.route !== g)
                                ) {
                                  e.next = 6;
                                  break;
                                }
                              ...
                              case 11:
                                if (
                                  ((j = e.sent),
                                  w(),
                                  "redirect-internal" !== (null == j || null == (b = j.effect) ? void 0 : b.type) &&
                                    "redirect-external" !== (null == j || null == (_ = j.effect) ? void 0 : _.type))
                                ) {
                                  e.next = 15;
                                  break;
                                }
                              ...
                              case 15:
                                ...
                                if (
                                  ((g = d.removeTrailingSlash(j.effect.resolvedHref)),
                                  (r = j.effect.resolvedHref),
                                  (n = c({}, n, j.effect.parsedAs.query)),
                                  (o = M.removeBasePath(y.normalizeLocalePath(j.effect.parsedAs.pathname, m.locales).pathname)),
                                  (P = m.components[g]),
                                ...
                                return e.abrupt("return", c({}, P, { route: g }));
                              case 23:
                                if ("/api" !== g && !g.startsWith("/api/")) {
                                  e.next = 26;
                                  break;
                                }
                                return te({ url: a, router: m }), e.abrupt("return", new Promise(function () {}));
                              case 26:
                                if (((e.t0 = E), e.t0)) {
                                  e.next = 31;
                                  break;
                                        ...
                                        return i.wrap(function (e) {
                                          for (;;)
                                            switch ((e.prev = e.next)) {
                                              ...
                                              case 8:
                                                return (
                                                  (t = e.t0), (u = t.json), (c = t.cacheKey), e.abrupt("return", { cacheKey: c, props: u || {} })
                                                );
                                              case 12:
                                                return (
                                                  (e.t1 = {}),
                                                  (e.next = 15),
                                                  m.getInitialProps(R.Component, {
                                                    pathname: r,
                                                    query: n,
                                                    asPath: a,
                                                    locale: l,
                                              ...
                                              case 15:
                                                return (e.t2 = e.sent), e.abrupt("return", { headers: e.t1, cacheKey: "", props: e.t2 });
                                              case 17:
                                              case "end":
                                                return e.stop();
                                            }
                              ...
                              case 39:
                                return (
                                  ...
                                  (A = C.props),
                                  (L = C.cacheKey),
                                  R.__N_SSP && S.dataHref && delete m.sdc[L],
                                  !m.isPreview &&
                                    R.__N_SSG &&
                                    J(Object.assign({}, S, { isBackground: !0, persistCache: !1, inflightCache: X })).catch(function () {}),
                              ...
                              case 53:
                                return (
                                  (e.prev = 53), (e.t1 = e.catch(1)), e.abrupt("return", m.handleRouteInfoError(v.getProperError(e.t1), r, n, a, s))
                                );
                              case 56:
                              case "end":
                                return e.stop();
                      ...
                      return i.wrap(function (a) {
                        for (;;)
                          switch ((a.prev = a.next)) {
                            ...
                            case 7:
                              if (
                                ((s = a.sent), (l = t), (f = "undefined" !== typeof r.locale ? r.locale || void 0 : n.locale), !t.startsWith("/"))
                              ) {
                                a.next = 20;
                                break;
                              }
                            ...
                            case 13:
                              ...
                              return a.abrupt("return");
                            case 18:
                              (l = k.removeLocale(M.removeBasePath(m.asPath), n.locale)),
                                m.matchedPage && m.resolvedHref && ((u = m.resolvedHref), (o.pathname = u), (e = O.formatWithValidation(o)));
                            case 20:
                              (o.pathname = Z(o.pathname, s)),
                                _.isDynamicRoute(o.pathname) &&
                                  ((u = o.pathname),
                                  (o.pathname = u),
                                  Object.assign(c, E.getRouteMatcher(S.getRouteRegex(o.pathname))(j.parsePath(t).pathname) || {}),
                                ...
                                Promise.all([
                                  n.pageLoader._isSsg(y).then(function (t) {
                                    return (
                                      !!t &&
                                      J({
                                        dataHref: n.pageLoader.getDataHref({ href: e, asPath: l, locale: f }),
                                        isServerRender: !1,
                                        parseJSON: !0,
                                        inflightCache: n.sdc,
                        ...
                        function (r) {
                          for (;;)
                            switch ((r.prev = r.next)) {
                              case 0:
                                return (n = re({ route: e, router: t })), (r.prev = 1), (r.next = 4), t.pageLoader.loadPage(e);
                              case 4:
              ...
              },
              {
                key: "_getFlightData",
                value: function (e) {
                  return J({ dataHref: e, isServerRender: !0, parseJSON: !1, inflightCache: this.sdc, persistCache: !1, isPrefetch: !1 }).then(
                    function (e) {
                      return { data: e.text };
                    }
                  );
              ...
              },
              {
                ...
                value: function (e, t) {
                  var r = this.components["/_app"].Component,
                    n = this._wrapApp(r);
                  return (t.AppTree = n), b.loadGetInitialProps(r, { AppTree: n, Component: e, router: this, ctx: t });
                },
              },
              {
                key: "route",
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.parsePath = function (e) {
          var t = e.indexOf("#"),
            ...
            n = r > -1 && (t < 0 || r < t);
          if (n || t > -1)
            return { pathname: e.substring(0, n ? r : t), query: n ? e.substring(r, t > -1 ? t : void 0) : "", hash: t > -1 ? e.slice(t) : "" };
    ...
    48675: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.getPathMatch = function (e, t) {
          var r = [],
            a = i.pathToRegexp(e, r, { delimiter: "/", sensitive: !1, strict: null == t ? void 0 : t.strict }),
    ...
    65039: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.prepareDestination = function (e) {
          ...
          for (var w = u.compile(y, { validate: !1 }), P = u.compile(g, { validate: !1 }), E = 0, S = Object.entries(m); E < S.length; E++) {
            var O = n(S[E], 2),
              j = O[0],
              R = O[1];
            Array.isArray(R)
          ...
          var k,
            M = Object.keys(e.params).filter(function (e) {
          ...
          return (v.query = i({}, t, v.query)), { newUrl: k, destQuery: m, parsedDestination: v };
        });
      var i = r(6495).Z,
        u = r(74329),
        c = r(79817),
      ...
      function d(e, t) {
        ...
        for (var r = 0, n = Object.keys(t); r < n.length; r++) {
          ...
          e.includes(":".concat(a)) &&
            (e = e
              .replace(new RegExp(":".concat(a, "\\*"), "g"), ":".concat(a, "--ESCAPED_PARAM_ASTERISKS"))
              .replace(new RegExp(":".concat(a, "\\?"), "g"), ":".concat(a, "--ESCAPED_PARAM_QUESTION"))
              .replace(new RegExp(":".concat(a, "\\+"), "g"), ":".concat(a, "--ESCAPED_PARAM_PLUS"))
              .replace(new RegExp(":".concat(a, "(?!\\w)"), "g"), "--ESCAPED_PARAM_COLON".concat(a)));
        }
        return (
          (e = e
            .replace(/(:|\*|\?|\+|\(|\)|\{|\})/g, "\\$1")
        ...
        (t.default = function (e, t, r, l, f, d) {
          for (
            var p,
              ...
              y = i.removeTrailingSlash(u.normalizeLocalePath(c.removeBasePath(m.pathname), d).pathname),
              g = function (r) {
                var s = a.getPathMatch(r.source + "", { removeUnnamedParams: !0, strict: !0 })(m.pathname);
                ...
                if (s) {
                  ...
                  var b = o.prepareDestination({ appendParamsToQuery: !0, destination: r.destination, params: s, query: l });
                  if (
                    ((m = b.parsedDestination),
                    (e = b.newUrl),
                    Object.assign(l, b.parsedDestination.query),
                    (y = i.removeTrailingSlash(u.normalizeLocalePath(c.removeBasePath(e), d).pathname)),
                    t.includes(y))
                  )
                    return (h = !0), (p = y), !0;
          ...
          return { asPath: e, parsedAs: m, matchedPage: h, resolvedHref: p, externalDest: v };
        });
      var a = r(48675),
        o = r(65039),
        i = r(15323),
    ...
    76927: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.getNamedRouteRegex = function (e) {
          var t = s(e);
          return n({}, c(e), { namedRegex: "^".concat(t.namedParameterizedRoute, "(?:/)?$"), routeKeys: t.routeKeys });
        }),
            ...
            .map(function (e) {
              if (e.startsWith("[") && e.endsWith("]")) {
                var t = i(e.slice(1, -1)),
                  ...
                  u = t.optional,
                  c = t.repeat;
                return (r[o] = { pos: n++, repeat: c, optional: u }), c ? (u ? "(?:/(.+?))?" : "/(.+?)") : "/([^/]+?)";
              }
            ...
            .map(function (e) {
              if (e.startsWith("[") && e.endsWith("]")) {
                ...
                return (
                  ...
                  l && (s = r()),
                  (n[s] = o),
                  c ? (u ? "(?:/(?<".concat(s, ">.+?))?") : "/(?<".concat(s, ">.+?)")) : "/(?<".concat(s, ">[^/]+?)")
                );
              }
              return "/".concat(a.escapeStringRegexp(e));
            })
          ...
          o(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  (null !== this.slugName && a.push.apply(a, n(this.children.get("[]")._smoosh("".concat(t, "[").concat(this.slugName, "]/")))),
                  !this.placeholder)
                ) {
                  var o = "/" === t ? "/" : t.slice(0, -1);
                ...
                return (
                  null !== this.restSlugName &&
                    a.push.apply(a, n(this.children.get("[...]")._smoosh("".concat(t, "[...").concat(this.restSlugName, "]/")))),
                  null !== this.optionalRestSlugName &&
                    a.push.apply(a, n(this.children.get("[[...]]")._smoosh("".concat(t, "[[...").concat(this.optionalRestSlugName, "]]/")))),
                  a
                );
              },
            },
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 17:
                    ...
                    throw (
                      ((o = '"'.concat(h(t), '.getInitialProps()" should resolve to an object. But found "').concat(a, '" instead.')), new Error(o))
                    );
                  case 20:
                    return e.abrupt("return", a);
                  case 22:
        ...
        return (
          (e.exports = u =
            function (e) {
              ...
              return (
                (t.prototype = Object.create(e.prototype, { constructor: { value: t, enumerable: !1, writable: !0, configurable: !0 } })), a(t, e)
              );
            }),
          (e.exports.default = e.exports),
          (e.exports.__esModule = !0),
      ...
      function r(e, t) {
        ...
        for (
          ...
          if (v || m) {
            ...
            -1 === a.indexOf(y) && ((l += y), (y = "")),
              l && (u.push(l), (l = "")),
              u.push({ name: v || c++, prefix: y, suffix: "", pattern: m || i, modifier: f("MODIFIER") || "" });
          } else {
            ...
            if (g) l += g;
              ...
              var b = f("NAME") || "",
                _ = f("PATTERN") || "",
                x = p();
              d("CLOSE"), u.push({ name: b || (_ ? c++ : ""), pattern: b && !_ ? i : _, prefix: y, suffix: x, modifier: f("MODIFIER") || "" });
            } else d("END");
          }
        }
        return u;
        ...
        return (
          ...
          (j.prototype = {
            ...
            delegateYield: function (e, r, n) {
              return (this.delegate = { iterator: R(e), resultName: r, nextLoc: n }), "next" === this.method && (this.arg = t), h;
            },
          }),
          e
        );
        ...
        var n,
          ...
          d = function (e, t) {
            var r = l(),
              n = "navigate";
            return (
              c >= 0 ? (n = "back-forward-cache") : r && (n = document.prerendering || f() > 0 ? "prerender" : r.type.replace(/_/g, "-")),
              {
                name: e,
                value: void 0 === t ? -1 : t,
                rating: "good",
              ...
              i = function (e) {
                e.forEach(function (e) {
                  "first-contentful-paint" === e.name &&
                    (c && c.disconnect(), e.startTime < a.firstHiddenTime && ((o.value = e.startTime - f()), o.entries.push(e), r(!0)));
                });
              },
          ...
          H = function (e, t) {
            t = t || {};
            var r = [200, 500];
            "interactionCount" in performance || u || (u = p("event", T, { type: "event", buffered: !0, durationThreshold: 0 }));
            var n,
              a = d("INP"),
              o = function (e) {
                e.forEach(function (e) {
...
document.addEventListener("DOMContentLoaded", function () {
  const closeButtons = document.querySelectorAll(".btn_close_pop");

  closeButtons.forEach((button) => {
    button.addEventListener("click", function () {
      const popupElement = this.closest(".tg_popup_ads");
  ...
  const mainPopup = document.querySelector(".tg_popup_ads");
...
jQuery(document).ready(function () {
  jQuery(document).on("click", ".gmoGroupHeader_menuBtn ", function () {
    jQuery(this).toggleClass("gmoGroupHeader_menuBtn-open");
  });

  jQuery(document).on("click", ".gmoGroupHeader_serviceWrap .gmoGroupHeader_service .gmoGroupHeader_service_label", function () {
    jQuery(this).closest(".gmoGroupHeader_service").toggleClass("gmoGroupHeader_service-activeSP");
    jQuery(this).siblings().toggleClass("gmoGroupHeader_service-activeSP");
  });

  jQuery(document).on("click", ".gmoGroupHeader_countries_head", function () {
    jQuery(this).toggleClass("gmoGroupHeader_countries_head-open").siblings().removeClass("gmoGroupHeader_countries_head-open");
  });

  jQuery(document).on("click", ".gmoGroupHeader_list_head1", function () {
    jQuery(this).toggleClass("gmoGroupHeader_list_head1-open");
  });
});
