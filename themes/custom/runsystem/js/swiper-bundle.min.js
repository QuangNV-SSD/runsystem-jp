  ...
  var B = {
    ...
    updateSlidesClasses: function () {
      ...
      if (r)
        ...
        n
          ? ((o = t.filter((e) => e.column === i)[0]), (c = t.filter((e) => e.column === i + 1)[0]), (d = t.filter((e) => e.column === i - 1)[0]))
          : (o = t[i]);
      o &&
        (n ||
          ((c = (function (e, t) {
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          Object.assign(e, {
            ...
            s &&
              (f ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !g && w ? (e.loopCreate(t), e.updateSlides()) : g && !w && e.loopDestroy()),
            e.emit("breakpoint", l);
        },
      ...
      const x = (e, t, s) => {
        ...
        P = (e) => {
          ...
          a ||
            ...
            requestAnimationFrame(() => {
              r ||
                (t.params.loop ? t.slideToLoop(parseInt(s.getAttribute("data-swiper-slide-index")), 0) : t.slideTo(t.slides.indexOf(s), 0), (r = !1));
            }));
        },
        L = () => {
